...
Documentation on using each of the NOAA RDHPCS systems is available.  Please
refer to the specific user pages for more information.


In addition, the `NOAA Information Technology Locations and Systems page
...
.. |ppan_url|        replace:: https://www.noaa.gov/organization/information-technology/ppan

.. |gaeaP|   replace:: Long- and Short-term forecast Modeling and Research
...
.. |ppanP|   replace:: Post-processing and analysis of high-resolution model data
...
+------------------+----------+-------------------+---------------------------+
| PPAN             | |ppanP|  | |ppan_url|        | :ref:`ppan-user-guide`    |
+------------------+----------+-------------------+---------------------------+
