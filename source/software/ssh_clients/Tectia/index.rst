...
number assigned to you when you login to the RDHPCS. Port numbers are
...
* Host: localhost (This is literal string, that is, enter the word
  "localhost")
* Port: Your-assigned-local-port-on-bastion (This is the number
  listed as Local Port when you login)
* User: Your First.Last user name
